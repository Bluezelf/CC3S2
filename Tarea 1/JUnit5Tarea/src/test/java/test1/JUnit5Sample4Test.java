...
public class JUnit5Sample4Test {
    ...
    // @Nested Esta anotación se utiliza para anidar clases internas que contienen pruebas relacionadas. 
    // Cada clase interna puede tener sus propios métodos @BeforeEach y @AfterEach que se ejecutarán antes y después de cada prueba dentro de esa clase interna.
    @Nested
    class InnerClass {
